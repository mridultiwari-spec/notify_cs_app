            ...
            <div class="right-panel">
                <div class="variable-box">
                    ...
                    <div class="variable-list">
                        ...
                        <div class="variable-item">{{ checkout_name }}</div>
                        <div class="variable-item">{{ customer_full_name }}</div>
                        <div class="variable-item">{{ phone_number }}</div>
                        <div class="variable-item">{{ currency }}</div>
                        <div class="variable-item">{{ email_id }}</div>
