...
$aid = isset($_GET['aid']) ? (int) $_GET['aid'] : (isset($_POST['aid']) ? (int) $_POST['aid'] : 1);
...
<body>
    ...
    <script>
        ...
        function addButton() {
            console.log('Current button count:', buttonCount);
        ...
        function removeButton(buttonNumber) {
            ...
            if (buttonGroup) {
                ...
                for (var i = 0; i < remainingButtons.length; i++) {
                    ...
                    if (titleSpan) {
                        titleSpan.textContent = 'Button ' + newNumber;
                    }
                    var removeBtn = group.querySelector('.remove-button-btn');
                    if (removeBtn) {
                        removeBtn.setAttribute('onclick', 'removeButton(' + newNumber + ')');
                    }
                    ...
                    if (textInput) {
                        textInput.setAttribute('name', 'button_text' + newNumber);
                    }
                    ...
                    if (urlField) {
                        ...
                        if (urlInput) {
                            urlInput.setAttribute('name', 'button_url' + newNumber);
                        }
                    }
                }
            }
