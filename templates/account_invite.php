...
$aid = isset($_GET['aid']) ? (int) $_GET['aid'] : (isset($_POST['aid']) ? (int) $_POST['aid'] : 9);
...
<head>
    ...
    <title>Customer Account Invite</title>
</head>
    ...
    <div class="container-box">
        <div class="page-header">
            <div class="header-left">
                ...
                <div class="page-title">Customer Account Invite</div>
            </div>
        </div>
            ...
            <div class="left-panel">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="tab-content" id="whatsapp">
                        ...
                        <div class="condition-box" id="mediaFileBox" style="display:none;">
                            <input type="file" name="media_file" id="media_file_input" class="condition-input">
                        </div>
                    ...
                    xhr.onreadystatechange = function () {
                        ...
                        if (xhr.status === 200) {
                            ...
                            if (data && data.success) {
                                // If this was a file upload, update the generated URL field
                                if (data.media_url) {
